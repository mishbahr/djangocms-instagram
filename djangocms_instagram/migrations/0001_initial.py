    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', connected_accounts.fields.AccountField(on_delete=models.deletion.CASCADE, verbose_name='Connected Account', to='connected_accounts.Account', provider='instagram', help_text='Select a connected Instagram account or connect to a new account.')),
            ],
            options={
                'abstract': False,
            },
